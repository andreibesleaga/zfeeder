...
define("ZF_LOGINTYPE","session"); // server - server HTTP auth; session - PHP sessions auth
define("ZF_URL","http://127.0.0.1:8090/newsfeeds/"); // URL to zFeeder newsfeeds directory installation; ends with /
define("ZF_ADMINNAME","admin"); // admin username
define("ZF_ADMINPASS","77849598f2e153a7b06f591f9de07c67"); // crypted admin password, default is none (empty)
